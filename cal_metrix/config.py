...
E           = EasyDict(func='networks.Encoder')
NE          = EasyDict(func='networks_glow.norm_encoder')
ND          = EasyDict(func='networks_glow.norm_decoder')
VGG19       = EasyDict(func='networks_glow.vgg19')
G_opt       = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-8) # Options for generator optimizer.
D_opt       = EasyDict(beta1=0.0, beta2=0.99, epsilon=1e-8) # Options for discriminator optimizer.
Norm_opt    = EasyDict(beta1=0.9, beta2=0.99, epsilon=1e-8)
